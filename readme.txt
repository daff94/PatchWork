...
Initialisation :
1 - listeFichier.php : Permet de trouver et charger les photos depuis un répertoire (images) dans la base de données

2 - dominante.php : Pour chaque image trouvée en base, on recherche les dominantes (jusqu'à 8)
